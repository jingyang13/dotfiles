...
function M.set_highlights()
	...
	-- 未保存圆点的高亮（这里用了明亮的黄色，你也可以改成和关闭图标一样的红色 #BF616A）
	vim.api.nvim_set_hl(0, "MyBufModified", { fg = "#E5C07B", bg = "#3E4451" })
	vim.api.nvim_set_hl(0, "MyBufModifiedInactive", { fg = "#E5C07B", bg = "#282C34" })
end
